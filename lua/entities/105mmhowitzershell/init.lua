...
self:Think()
 ...
 function ENT:Think()
	...
	if (tr.Hit) then
		util.BlastDamage(self.Entity, self.Entity, self.Entity:GetPos(), 1000, 450)
		...
		local attack = cbt_hcgexplode( self.Entity:GetPos(),300, 200, 10)
		self.exploded = true
		self.Entity:Remove()
	...
	self.flightvector = self.flightvector + Vector(math.Rand(-0.10,0.10), math.Rand(-0.1,0.1),math.Rand(-0.1,0.1)) + Vector(0,0,-0.6)
