...
function ENT:Initialize()   
	...
	self.Inputs = Wire_CreateInputs( self.Entity, { "Fire AP"} )
...
function ENT:firerac5()
		...
		local ent = ents.Create( "230mmshell" )
		...
		local phys = self.Entity:GetPhysicsObject()  	
		if (phys:IsValid()) then  		
			phys:ApplyForceCenter( self.Entity:GetUp() * -10000000 ) 
		end 
		...
		self.Entity:EmitSound( "arty/230mm.wav", 500, 100 )
