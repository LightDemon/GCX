 ...
 function ENT:Think()
	...
	if tr.Hit then
		util.BlastDamage(self.Entity, self.Entity, self.Entity:GetPos(), 350, 200)
			...
			local attack = gcombat.hcgexplode( self.Entity:GetPos(), 300, 200, 7)
			self.Entity:Remove()
		
	end
	
	self.Entity:SetPos(self.Entity:GetPos() + self.flightvector)
	self.flightvector = self.flightvector + Vector(math.Rand(-0.07,0.07), math.Rand(-0.07,0.07),math.Rand(-0.07,0.07)) + Vector(0,0,-0.1)
