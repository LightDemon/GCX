...
self.Entity:SetModel( "models/combatmodels/tankshell_230mm.mdl" )
 ...
 function ENT:Think()
	...
	if tr.Hit then
		util.BlastDamage(self.Entity, self.Entity, self.Entity:GetPos(), 250, 200)
			...
			local attack = gcombat.hcgexplode( self.Entity:GetPos(), 200, 5500, 7)
			self.Entity:Remove()
		
	end
	
	self.Entity:SetPos(self.Entity:GetPos() + self.flightvector)
	self.flightvector = self.flightvector + Vector(math.Rand(-0.18,0.18), math.Rand(-0.18,0.18),math.Rand(-0.18,0.18)) + Vector(0,0,-0.3)
