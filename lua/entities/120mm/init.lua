...
function ENT:fireap()
		...
		effectdata:SetOrigin(self.Entity:GetPos() +  self.Entity:GetUp() * 60)
		effectdata:SetStart(self.Entity:GetPos() +  self.Entity:GetUp() * 60)
		util.Effect( "tankflash", effectdata )
		self.Entity:EmitSound( "arty/cannon2.wav", 500, 100 )
