...
function ENT:SpawnFunction( ply, tr)
	...
	local ent = ents.Create( "ERLargeLaser" )
		ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Activate()
	...
	if (self.ammos > 0) then
		...
		if (tr.Hit && tr.Entity:IsValid()) then
			if ( !tr.Entity:IsWorld() || !tr.Entity:IsPlayer() || !tr.Entity:IsNPC() || !tr.Entity:IsVehicle()) then
				gcombat.nrghit( tr.Entity, 80, 7, tr.HitPos, tr.HitPos)
		...
		gcombat.nrghit( tr.Entity, 74, 5, tr.HitPos, tr.HitPos)
		...
		util.Effect( "LargeLaserBeam", effectdata )
