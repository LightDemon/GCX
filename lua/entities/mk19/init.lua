...
function ENT:Initialize()   
	...
	self.reloadtime = 0
	self.infire = false
	self.Entity:SetModel( "models/props_c17/pottery05a.mdl" ) 	
...
function ENT:firerac5()
		...
		local ent = ents.Create( "mk19shell" )
		ent:SetPos( self.Entity:GetPos() +  self.Entity:GetUp() * 60)
		ent:SetAngles( self.Entity:GetAngles() )
		ent:Spawn()
		ent:Activate()
		
		self.Entity:EmitSound( "arty/mk19.wav", 500, 100 )
...
if FIELDS == nil and COMBATDAMAGEENGINE == nil then return end
	...
	self.Entity:NextThink( CurTime() + .29)
	return true
end
