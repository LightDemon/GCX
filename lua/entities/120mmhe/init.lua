...
self.flightvector = self.Entity:GetUp() * 275
...
if tr.Hit then
util.BlastDamage(self.Entity, self.Entity, tr.HitPos, 250, 200)
...
local attack = gcombat.hcgexplode( tr.HitPos, 50, 3500, 7)
self.Entity:Remove()

end
	
	self.Entity:SetPos(self.Entity:GetPos() + self.flightvector)
	self.flightvector = self.flightvector + Vector(math.Rand(-0.07,0.07), math.Rand(-0.07,0.07),math.Rand(-0.07,0.07)) + Vector(0,0,-0.05)
