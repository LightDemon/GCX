...
function ENT:firerac5()
		...
		local ent = ents.Create( "mg151shell" )
		...
		self.Entity:EmitSound( "ww2/mg151.wav", 500, 100 )
...
Wire_TriggerOutput(self.Entity, "Shots", self.ammos)
	...
	self.Entity:NextThink( CurTime() + .09)
	return true
end
