...
function ENT:launchthor()

	if (self.ammos > 0) then
		self.ammos = self.ammos - 1
	
		local ent = ents.Create( "srbm" )
		ent:SetPos( self.Entity:GetPos() +  self.Entity:GetUp() * 600)
...
function ENT:Think()
	...
	if (self.armed == true) then
			...
			self:launchthor()			
			self.Entity:SetColor(75,75,75,0)
